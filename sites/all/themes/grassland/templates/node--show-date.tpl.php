...
<div class="large-5 columns">
	...
	<h4>Address</h4>
	<h5><?php print $node->field_address[$node->language][0]['value']; ?></h5>
</div>	
<div class="large-7 columns map">
	<iframe width="100%" height="450" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?q=<?php print $node->field_address[$node->language][0]['value']; ?>%2C%20United%20States&key=AIzaSyBw72LTIxpCq19SL6FHL8LoIvkOMXCauAw"></iframe>
</div>	